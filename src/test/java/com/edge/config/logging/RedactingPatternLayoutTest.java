...
public class RedactingPatternLayoutTest {
  @Test
  ...
  public void testPartialRedactionWithInferredTypes() {
    ...
    // Check if redaction applied (pattern may vary but card number should be
    // redacted)
  ...
  public void testRedactionConfigFields() {
    ...
    // Test email redaction - note that we're testing with the actual mask string in
    // the config
